...
namespace Module.Core.Systems
{
    ...
    internal static class ThrowHelper
    {
        ...
        {
            throw new ArgumentException(System.String.Format("Arg_WrongType about key : {0} , targetType : {1} ", key, targetType));
        }

        internal static void ThrowWrongValueTypeArgumentException(object value, Type targetType)
        {
            throw new ArgumentException(System.String.Format("Arg_WrongType about value : {0} , targetType : {1} ", value, targetType));
        }
